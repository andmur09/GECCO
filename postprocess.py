...
def main():
    ...
    plt.figure()
    plt.scatter(no_uncontrollables, runtime, label="JCC", marker ="x", color="blue")
    plt.scatter(no_uncontrollables_LP, runtime_LP, label ="LP", marker =".", color="orange")
    ...
    plt.figure()
    plt.scatter(no_uncontrollables, cost, label="JCC", marker="x", color="blue")
    plt.scatter(no_uncontrollables_LP, cost_LP, label="LP", marker=".", color="orange")
    plt.legend(fontsize=9)
    plt.xlabel("No of Uncontrollable Constraints")
    plt.yscale('log')
    plt.ylabel("Cost")
